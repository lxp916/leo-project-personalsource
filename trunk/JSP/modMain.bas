...
On Error GoTo ErrorHandler
    ...
    Call Create_Field(dbTable_Name, "JOB_JUDGE", cDB_TEXT, False, 1, True)
    Call Create_Field(dbTable_Name, "JOB_GRADE", cDB_TEXT, False, 2, True)
    Call Create_Field(dbTable_Name, "INSP_JUDGE_DATA_EQ1", cDB_TEXT, False, 1, True)
    Call Create_Field(dbTable_Name, "INSP_JUDGE_DATA_EQ2", cDB_TEXT, False, 1, True)
    Call Create_Field(dbTable_Name, "INSP_JUDGE_DATA_EQ3", cDB_TEXT, False, 1, True)
    Call Create_Field(dbTable_Name, "INSP_JUDGE_DATA_EQ4", cDB_TEXT, False, 1, True)
    Call Create_Field(dbTable_Name, "INSP_JUDGE_DATA_EQ5", cDB_TEXT, False, 1, True)
