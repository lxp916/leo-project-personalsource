    ...
    public class FixedPage:Canvas
    {
        ...
        internal void LoadPage(Uri path)
        {
            ...
            using (System.Xml.XmlReader reader = System.Xml.XmlReader.Create(newStrem.Stream))
            {
                ...
                //string backgroundImage = "/Test;component/Assets/Images//page_single.png";
               
                //Image image = new Image();
                //ImageSource iss = new ImageSourceConverter().ConvertFrom();
                //image.SetValue(Image.SourceProperty, ConvertPartName(backgroundImage));
