                ...
                do
                {
                    if (!reader.IsDefault)
                    {
                        if (!Setting.RemoveAttribute.Contains(reader.LocalName))
                        {
                            ...
                            {
                                case "FontUri":
                                    writer.WriteAttributeString("my", "FixedPage.FontUri", "clr-namespace:YUMXPSViewer.Utility.XpsDocument;assembly=MyControl", reader.Value);
                                    break;
                                case "ImageSource":
                                    writer.WriteAttributeString("my", "FixedPage.ImageSource", "clr-namespace:YUMXPSViewer.Utility.XpsDocument;assembly=MyControl", reader.Value);
                                    break;
                                case "FixedPage.NavigateUri":
                                    writer.WriteAttributeString("my", "FixedPage.NavigateUri", "clr-namespace:YUMXPSViewer.Utility.XpsDocument;assembly=MyControl", reader.Value);
                                    break;
                                default:
