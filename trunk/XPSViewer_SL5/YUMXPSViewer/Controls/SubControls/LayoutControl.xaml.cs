...
namespace YUMXPSViewer.Controls
{
    public partial class LayoutControl : UserControl
    {
        ...
        public LayoutControl(ReaderControl readerControl)
        {
            ...
            ImagePathArray[0] = "/ReaderControl;component/Images/page_cont.png";
            ImagePathArray[1] = "/ReaderControl;component/Images/page_facing_cont.png";
            ImagePathArray[2] = "/ReaderControl;component/Images/page_cover_facing_cont.png";
            ImagePathArray[3] = "/ReaderControl;component/Images/page_single.png";            
            ImagePathArray[4] = "/ReaderControl;component/Images/page_facing.png";
            ImagePathArray[5] = "/ReaderControl;component/Images/page_cover_facing.png";
        ...
        private void LayoutButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            menuItemArray[2] = new MenuItem()
            {
                ...
                Header = "Cover Facing Continuous",
