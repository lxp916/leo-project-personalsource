...
namespace YUMXPSViewer.Controls.SubControls
{
	...
	{                
        ...
        public OutlineToggleButtonControl(ReaderControl reader)
        {
            ...
            expandedImage = new BitmapImage(new Uri("/ReaderControl;component/Images/section_expanded.png", UriKind.Relative));
            collapsedImage = new BitmapImage(new Uri("/ReaderControl;component/Images/section_collapsed.png", UriKind.Relative));
